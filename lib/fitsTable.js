(function() {
  ...
  FitsTable = (function() {
    ...
    FitsTable.prototype.readColumn = function() {
      var columnName, complex, highByte, i, lowByte, real, tform, value, _ref;
      ...
      for (i = 1, _ref = this.columns; 1 <= _ref ? i <= _ref : i >= _ref; 1 <= _ref ? i++ : i--) {
        ...
        switch (this.header[tform]) {
          ...
          case 'J':
            ...
            break;
          case 'K':
            highByte = this.view.getInt32();
            lowByte = this.view.getInt32();
            value = (highByte << 24) + lowByte;
            this.data[columnName].push(value);
            console.warn("This data format has not been tested");
            break;
          case 'A':
            this.data[columnName].push(this.view.getChar());
            break;
          case 'E':
